...
class CatalogView extends React.Component {
  ...
  showItemDetails = item => {
    ...
    this.setState({ detailsItem: item, showDetails: true, infoDismissed: true });
  };
  ...
  hideInfoIcon = () => {
    this.setState({ infoDismissed: false });
  };

  showCreateItemInstance = (url) => {
          ...
          {detailsItem &&
            showDetails && (
              <CatalogItemDetailsDialog
                ...
                onShowCreateInstance={() => this.showCreateItemInstance(detailsItem.preview)}
                onShowDialog={this.showDialog}
                infoDismissed={this.hideInfoIcon}
              />
            )}
